...
We thank the reviewer for this suggestion. We have added a subsection on Elo rating, with a mathematical defination followed by a calculation example.
...
We have expanded the case study in chess to include Elo ratings...

In addition, we have added new subsection with a case study in baseball about the evolution of data, tools, and statistical methodologies. We hope that these additional will help to flesh out the value of these tools. 
