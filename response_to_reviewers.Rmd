...
Our revision includes a significant bolstering of Sections 4, 5, and 6. In particular, we have added a subsection on Elo ratings, added a subsection on baseball tools, expanded and linked the discussion of graphical tools, and replaced some weak figures with more relevant substitutes. 
...
We thank the reviewer for this excellent suggestion. We have replaced Figure 6 with a new figure that illustrates in the `retrosheet` and `teamcolors` package can be combined to produce a meaningful data graphic. In particular, we note how the use of team colors clarifies what would otherwise be a messy jumble of indistinguishable lines. 
...
We have clarified our language on this subject. The reason for the comment was related to the increased resolution of player tracking data. We have made this reasoning explicit. 
...
We have added examples from the `SportyR` package, which draws playing surfaces, to help flesh out this subsection. We also replaced the previous Figure 6 with a new Figure 6 that illustrates how the use of team colors is particularly impactful for sports-releated data graphics.  
