...
Table \ref{tab:tennisbtm} shows the estimated coefficients of the fitted BTM. According to the abilities, the players are ranked as follows: 1) Djokovic, 2) Federer, 3) Wawrinka, 4) Murray, 5) Nadal. To obtain win probability, as an illustration, for the Federer-Nadal matchup, an estimate for the probability of a Federer victory is
$$
