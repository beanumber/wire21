...
In 2014, the *Journal of Quantitative Analysis in Sports* teamed up with Kaggle to create a March Madness competition to predict the winners of the NCAA men's basketball tournament. 
243 entrants competed for the $15,000 cash prize by submitting predicted probabilities for every possible pairwise matchup among the 68 teams in the tournament [@GlickmanSonas2015]. 
In the [special issue](https://www.degruyter.com/journal/key/jqas/11/1/html) that *JQAS* subsequently published, we learned that the winning entry was based on a fairly simple logistic regression model trained on betting market data [@lopez2015building].
Thus, the competition not only sparked interest in sports analytics, but resulted in peer-reviewed research that, in that case, demonstrated the value of superior data over sophisticated modeling. 
...
This annual competition has similarly fueled new research directions in American football and a [special issue](https://www.degruyter.com/journal/key/jqas/16/2/html) of *JQAS* [@lopez2020bigger].
...
Similar competitions include the [Big Data Cup](https://www.stathletes.com/big-data-cup/) for ice hockey and the [SABR Diamond Dollars Case Competition](https://sabr.org/analytics/case) for baseball.
