...
## Example of how to use betting market data

To see how betting market data can be used to estimate team strengths, consider the betting odds posted on [FanDuel Sportsbook for the 2023 NBA Champion](https://sportsbook.fanduel.com/navigation/nba?tab=nba-finals), posted on January 9, 2023 and shown in Figure \ref{tab:odds}. 
This is a futures market, because the actual NBA champion will not be determined until June 2023. 
The Boston Celtics are the favorite to win, with posted odds of $+390$, meaning that a \$100 bet on the Celtics to win the championship will pay out \$390 if the Celtics win it all. 
...
odds |>
  ...
  knitr::kable(
    ...
    digits = 3, 
    caption = "2023 NBA Championship line odds for the top 6 and bottom 6 teams. Retrieved from FanDuel Sportsbook on January 9, 2023. ")
```

These lines ($\ell_i$) can be converted into an implied probability ($p_i$) using the formula:
$$
