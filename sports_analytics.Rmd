...
abstract: |
  ...
  In this paper, we connect three big ideas that are common across multiple sports: the expected value of a game state, win probability, and measures of team strength.
  ...
  We also describe the use of non-performance data and opportunities to share analytical work, but omit an in-depth discussion of individual player evaluation as beyond our scope.
...
@koopman2015dynamic use a Bayesian state-space model to develop team ratings for English Premier League soccer that improves on bookmaker's odds. 
