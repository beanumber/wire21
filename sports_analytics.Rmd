...
Due to limitations regarding the amount of data collected, the football field is broken into 10-yard buckets, centered at their midpoints (e.g. 5, 15, 25, 35, etc.).
The estimated value for first and 10 situation on those field positions is calculated by averaging the points scored on the next scoring instance.
