...
They demonstrate than teams are still conservative when choosing to go for it or punt on 4th down, but the effect may be overstated. 

### Other applications of expected points in American football

Researchers have also applied the notion of expected points to investigate other aspects of the game of football, including quarterback performance and coaching decision. 
...
Accordingly, the model results can be used to obtain ratings and rankings for NFL passers.
