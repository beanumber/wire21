...
Even in sports where the concept of a state is not so easy to define, like basketball, the value of a possession can be estimated with player tracking data. @cervone2016multiresolution introduces expected possession value (EPV), providing a continuous-time estimate of the expected number of points for the offensive team on a given possession using player and ball locations.  
