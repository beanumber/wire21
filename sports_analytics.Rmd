...
@Stern1994 used Brownian motion to investigate the scoring process of basketball. The model introduced by @Stern1994 is a probit regression model, which provides an estimate for the probability of winning for a home team, taking into account the score difference between the teams and the current game time. 

@Deshpande2016 extended @Stern1994's framework by applying it in a Bayesian setting.

@McFarlane2019 used logistic regression to estimate win probability for evaluating end-of-game decisions in the NBA
