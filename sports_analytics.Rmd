...
In addition, @pelechrinis2019 develops an expected points framework in the same spirit as previous work, but accounts for the strength of the opponents in their method.  They state that by failing to account for opponent strength appropriately, about 124.8 points per team each season (or about 3.8 wins per season) are not credited correctly.  
...
Researchers have also applied the notion of expected points to evaluate other aspects of the game of football, including quarterback performance and coaching decision. 
...
This annual competition has similarly fueled new research directions in American football and a [special issue on player tracking data in the National Football League (NFL)](https://www.degruyter.com/journal/key/jqas/16/2/html) of *JQAS* [@lopez2020bigger].
