...
# The expected value of a possession {#sec:ev}
...
Mathematically, we distinguish between 
$$
  \max{\Pr[X > 0 | s]} \, \text{ and } \, \max{\mathbb{E}[X | s]} \,.
$$
Maximizing the probability of scoring is optimal in any sudden-death situation, which has (but currently does not) include overtime in American football [@martin2018markov]. 
