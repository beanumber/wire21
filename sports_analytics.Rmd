...
@lopez2020bigger presents an introduction to NFL tracking data, and as an example, examines 4th down behavior.  Rather than looking at the traditional distance to go, which is rounded, they have the exact position of the ball leading to an exact distance to go. They demonstrate that teams are still conservative when choosing to go for it or punting on 4th down, but the effect may be overstated. 
