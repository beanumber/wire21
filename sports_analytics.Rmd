...
In this technical note, the expected points for 1st and 10 plays in the NFL are estimated, given any yard line on the football field. 
...
Another attempt at modeling expected points in football is done by @goldner2012markov and @goldner2017situational, which proposes a Markov framework.
...
For example, one of the most notable and well-studied topic is the evaluation of 4th down strategy.
There is near universal consensus in the literature that NFL teams have been too conservative when making 4th down decisions. 
...
For instance, the NFL teams' colors and logos shown in Figure \ref{fig:nflfastr-wp} were provided by the \pkg{teamcolors} package. 
