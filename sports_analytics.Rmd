...
Since both ratings are below 2400, we apply a development coefficient of $K=20$ for this example.
...
$$
The author that played this game ended up with a victory, which means the associated score is $S_a = 1$.
