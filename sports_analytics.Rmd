...
@urschel2011 uses expected points to evaluate NFL coaching decisions on kickoffs.  Specifically, they look at surprise on-sides kicks vs regular kickoff and the decision to accept a touchback vs returning kickoff.  Using data from the 2009 NFL season, the conclude, as many have, that coaches in the NFL tend to make conservative decisions.  
